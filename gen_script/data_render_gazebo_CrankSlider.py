...
for i in range(0,1):
    ...
    this_mesh = o3d.io.read_point_cloud('/home/henri/catkin_ws/src/gen_script/datasets/RPW/RPW_dataset/models/3d_fuel_line2.ply')
    all_meshes['3d_fuel_line2'] = np.asarray(this_mesh.points)#, dtype= np.float32)
#print(all_meshes)
...
sample_num = 0  # set this to 0 at first run
...
for dist in np.arange(0.55,1.05,0.125):
    ...
    for phi in range(35,90,15):
            ...
            for theta in range(0, 360, 15):
                    ...
                    try:
                        ...
                        while rgb_duplicate:
                            ...
                            if sample_num > 0:  #No point checking for the sample 0
                                previous_im = cv2.imread('/home/henri/catkin_ws/src/gen_script/datasets/RPW/RPW_dataset/rgb/'+str(sample_num-1)+'.png', -1)
                        ...
                        while depth_duplicate:
                            ...
                            if sample_num > 0:
                                previous_im = cv2.imread('/home/henri/catkin_ws/src/gen_script/datasets/RPW/RPW_dataset/depth/'+str(sample_num-1)+'.png', -1)
                ...
                sio.savemat('/home/henri/catkin_ws/src/gen_script/datasets/RPW/RPW_dataset/meta/'+str(sample_num)+'-meta.mat',gt_dict)
                ...
                for i in np.argsort(-obj_cam_T[2,3,:]):
                    ...
                    cloud_temp = copy.deepcopy(all_meshes['3d_fuel_line2']).transpose().astype(np.float32) # We don't want to mess with the original copy
                    ...
                    this_mask[this_mask.nonzero()] = 1.05*np.ceil(255*(i+1)/5)
                ...
                cv2.imwrite('/home/henri/catkin_ws/src/gen_script/datasets/RPW/RPW_dataset/rgb/'+str(sample_num)+'.png', cv_image)
                cv2.imwrite('/home/henri/catkin_ws/src/gen_script/datasets/RPW/RPW_dataset/depth/'+str(sample_num)+'.png',cv_depthImage)
                cv2.imwrite('/home/henri/catkin_ws/src/gen_script/datasets/RPW/RPW_dataset/mask/'+str(sample_num)+'.png',obj_mask)
